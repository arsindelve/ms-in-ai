...
text adventures, and the work behind [newzork.ai](https://newzork.ai).

- [LinkedIn](https://www.linkedin.com/in/michaelnlane)
- ORCID: [0009-0006-5381-6080](https://orcid.org/0009-0006-5381-6080)

## Courses

| Course | Term | Title | In this repo |
| --- | --- | --- | --- |
| [CSCI 513.01W](CSCI-513) | Fall 2026 | Python Programming for AI | Assignments 2–3 |

More courses get added here as I take them.

## Layout

Each course folder follows the same shape:

```
CSCI-513/
├── README.md          course overview, instructor, assignment index
├── Syllabus.pdf       the syllabus as distributed
├── AssignmentTwo/     one folder per assignment: the prompt PDF,
└── AssignmentThree/   the source, and any data files it reads
```
